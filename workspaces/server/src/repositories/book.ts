...
type BookRepositoryInterface = {
  create(options: { body: PostBookRequestBody }): Promise<
    Result<PostBookResponse, HTTPException>
  >;
  delete(options: { params: DeleteBookRequestParams }): Promise<
    Result<DeleteBookResponse, HTTPException>
  >;
  read(options: { params: GetBookRequestParams }): Promise<
    Result<GetBookResponse, HTTPException>
  >;
  readAll(options: { query: GetBookListRequestQuery }): Promise<
    Result<GetBookListResponse, HTTPException>
  >;
  update(options: {
...
class BookRepository implements BookRepositoryInterface {
  async read(options: { params: GetBookRequestParams }): Promise<
    Result<GetBookResponse, HTTPException>
  > {
    try {
  ...
  async readAll(options: { query: GetBookListRequestQuery }): Promise<
    Result<GetBookListResponse, HTTPException>
  > {
    try {
  ...
  async create(options: { body: PostBookRequestBody }): Promise<
    Result<PostBookResponse, HTTPException>
  > {
    try {
  ...
  async delete(options: { params: DeleteBookRequestParams }): Promise<
    Result<DeleteBookResponse, HTTPException>
  > {
    try {
